    ...
    <div id="mypage-menu-content" class="hidden lg:block p-5 pt-0 lg:p-0">
        <div class="mb-6 lg:mb-8 pt-2 lg:pt-0">
            ...
            <ul class="grid grid-cols-2 lg:grid-cols-1 gap-2 lg:space-y-3">
                ...
                <li><a href="{{ route('mypage.shipping-address') }}" class="block px-3 py-2 lg:p-0 rounded-lg lg:rounded-none bg-gray-50 lg:bg-transparent text-xs lg:text-sm font-medium {{ request()->routeIs('mypage.shipping-address') ? 'text-primary font-bold lg:underline bg-primary-light lg:bg-transparent' : 'text-text-main hover:text-primary' }} transition-colors">배송지 관리</a></li>
