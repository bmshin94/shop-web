...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden font-display relative">
        <form id="product-form" action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="p-8 md:p-10 space-y-10">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" placeholder="상품 이름을 입력해주세요" class="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-2xl text-base focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition-all">
                    </div>
                </div>
                <div class="space-y-2">
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input type="text" id="price" name="price" value="{{ old('price') }}" inputmode="numeric" class="w-full pl-10 pr-5 py-4 bg-gray-50 border border-gray-200 rounded-2xl text-base focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none format-number">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="stock_quantity" value="{{ old('stock_quantity', 0) }}" inputmode="numeric" class="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-2xl text-base focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none text-center format-number">
                    </div>
                </div>
            </div>
