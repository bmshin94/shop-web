        ...
        <div class="flex-1 w-full space-y-8">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-border-color p-6 sm:p-8">
                ...
                <div class="flex items-center justify-between">
                    <a href="{{ route('mypage.order-list', ['status' => '결제대기']) }}" class="flex flex-col items-center gap-3 group">
                        ...
                        <p class="text-xs font-bold text-text-muted group-hover:text-text-main">입금대기</p>
                        <p class="text-lg font-black text-text-main">{{ number_format($orderStats['pending']) }}</p>
                    </a>
                        ...
                        <tbody class="divide-y divide-border-color">
                            ...
                            <tr class="hover:bg-gray-50/30 transition-colors">
                                <td class="px-6 py-4">
                                    ...
                                    <a href="{{ route('mypage.order-detail', ['order' => $order->order_number]) }}" class="text-sm font-bold text-text-main hover:underline">{{ $order->order_number }}</a>
                                </td>
                                <td class="px-6 py-4">
