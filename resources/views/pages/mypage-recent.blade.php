                                ...
                                <div class="mt-4 flex flex-1 flex-col px-1">
                                    ...
                                    <div class="mt-4 flex gap-2">
                                        <button type="button" 
                                                ...
                                                data-has-options="{{ ($product->colors->count() > 0 || $product->sizes->count() > 0) ? 1 : 0 }}">                                            <span class="material-symbols-outlined text-[18px] group-hover/buy:scale-110 transition-transform">shopping_bag</span>
                                        </button>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="flex flex-col h-[85vh] md:h-auto max-h-[800px]">
            <div class="px-8 py-6 border-b border-gray-50 flex items-center justify-between shrink-0">
                <div>
                    ...
                    <p class="text-[11px] font-bold text-text-muted uppercase tracking-wider mt-1">Select options for your item</p>
                </div>
                    ...
                    Promise.all(reqs).then((responses) => { 
                        ...
                        if (duplicateResponse && !force) {
                            showConfirm(duplicateResponse.message, { 
                                ...
                                if (res) addProductsToCart(products, true); 
                            });
                            return;
                        }
