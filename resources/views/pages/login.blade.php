  ...
  <div class="w-full max-w-md space-y-8 bg-white p-8 sm:p-10 rounded-3xl shadow-xl border border-gray-100">
    ...
    <form class="mt-8 space-y-6" action="#" method="POST">
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="text-sm">
          <a href="#" class="font-bold text-primary hover:text-red-600 transition-colors">비밀번호를 잊으셨나요?</a>
        </div>
      </div>
    ...
    <div class="mt-8">
      ...
      <div class="mt-6 grid grid-cols-2 gap-3">
        <a href="#" class="flex w-full items-center justify-center gap-2 rounded-xl bg-[#fae100] px-4 py-3 hover:bg-[#ebd300] transition-colors">
        ...
        <a href="#" class="flex w-full items-center justify-center gap-2 rounded-xl bg-[#03c75a] px-4 py-3 hover:bg-[#02b351] transition-colors">
    ...
    <div class="pt-6 text-center border-t border-gray-100 mt-6">
      <p class="text-sm text-text-muted">
        아직 회원이 아니신가요?
        <a href="#" class="font-bold text-primary hover:underline ml-1">회원가입하기</a>
      </p>
    </div>
  </div>
</div>
